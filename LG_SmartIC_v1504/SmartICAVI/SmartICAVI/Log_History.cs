...
namespace SmartICAVI
{
    class Log_History
    {
        static LogUtill log = new LogUtill("History");
        static string logHead = " <History>  ";
        ...
        {
            log.Write(message);
            Log_Trace.WriteLine(logHead + message);
        ...
        public static void WriteLine(string formatString, params object[] args)
        {
            ...
            Log_Trace.WriteLine(logHead + string.Format(formatString, args));
